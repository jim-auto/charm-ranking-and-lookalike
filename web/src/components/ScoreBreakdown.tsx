    ...
    <div className="mt-10 border-t border-slate-800 pt-6">
      ...
      {open && (
        <div className="mt-4 space-y-6 text-sm text-slate-300">
          ...
          <section>
            <h3 className="mb-2 font-semibold text-white">等身 (参考・現在未反映)</h3>
            <p className="text-slate-400">
              等身も検討しましたが、芸能人データの大半が顔中心の写真で
              全身データが十分にそろわないため、現状はランキング/診断どちらにも
              反映していません。全身データを増やせ次第、指標として追加予定です。
            </p>
          </section>
